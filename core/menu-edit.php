        ...
        <div class="jumbotron row">
            <div class="col">
                ...
                <form action="/menu-update/" method="post">
                    ...
                    <div class="input-group mb-1">
                        <button type="submit" class="btn btn-success btn-sm"><i class="fas fa-save"></i>Update</button> | <a href="/menu/" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i> Cancel</a>
                    </div>
                </table>
                </form>
            </div>
