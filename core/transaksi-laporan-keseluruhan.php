<div class="jumbotron col-9">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2>Rekapitulasi Transaksi Keseluruhan</h2>
                <div class="input-group mb-1">
                    <span class="input-group-text lebar1">Dari</span>
                    <input type="date" id="periodeDari" class="form-control form-control-sm" value="" disabled>
                    <span class="input-group-text lebar1">Sampai</span>
                    <input type="date" id="periodeSampai" class="form-control form-control-sm" value="" disabled>
                ...
                <div id="tampilkanTransaksiPeriode">
                    <table class="table table-bordered table-responsive table-hover table-sm" id="tblTransaksi">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            // $sql = "CALL pPetugas()";
                            $sql = "SELECT * FROM tbl_transaksi ORDER BY tgl_transaksi ASC, no_transaksi";
    ...
    $(document).ready(function(){
        ...
        $(document).on('click','transaksiAksi2', function(){
            ...
            $.ajax({
                ...
                url:'/transaksi-delete-ajax/',
                cache:false,
                success:function(){
                    $('#tampilkanTransaksiPeriode').load('/transaksi-cari-periode/', {periodeDari:periodeDari, periodeSampai:periodeSampai});
                }
            });
        });
    });
