            ...
            <div class="col">
                ...
                <form action="/pegawai-update" method="post" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-1 input-sm">
                        <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-save"></i> Update </button> | <a href="/pegawai/" class="btn btn-sm btn-warning"><i class="fas fa-redo"></i> Cancel</a>
                    </div>
                </table>
            </form>
        </div>
