                ...
                <table class="table table-bordered table-hover table-responsive" id="pegawai">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$data["telp"];?></td>
                            <td><?=$data["jabatan"];?></td>
                            <td width="18%"><a href="/pegawai-edit/?id_pegawai=<?=$data["id_pegawai"];?>" class="badge badge-primary p-2" title="Edit"><i class="fas fa-edit"></i></a> | <a href="/pegawai-delete/?id_pegawai=<?=$data["id_pegawai"];?>" onclick="return confirm('Data akan dihapus ?');" class="badge badge-danger p-2" title="Delete"><i class="fas fa-trash"></i></a></td>
                        </tr>
                        <?php
                        }?>
                    </tbody>
