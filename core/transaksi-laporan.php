    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#periodeCari', function(){
            ...
            $.ajax({
                ...
                url:'/transaksi-cari-periode/',
                cache:false,
                success:function(){
                    $('#tampilkanTransaksiPeriode').load('/transaksi-cari-periode/',{
        ...
        $(document).on('click', '#periodeBack', function(){
            location.href = "/transaksi-laporan/";
        });
...
<?php
    ...
    if($_REQUEST["detail"] == "bulan_ini"){
        ...
        echo "<script>location.href = '/transaksi-laporan/'</script>";
    }
?>
