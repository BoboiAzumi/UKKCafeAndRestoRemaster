            ...
            <table class="table table-bordered table-hover table-responsive" id="kelas">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="center" width="25%"><a href="/menu-edit/?id_menu=<?=$data["id_menu"];?>" class="badge badge-primary p-2" title="Edit" class="badge badge-primary p-2" title="Edit"><i class="fas fa-edit"></i></a> | <a href="/menu-delete/?id_menu=<?=$data["id_menu"];?>" onclick="return confirm('data akan dihapus ?');" class="badge badge-danger p-2" title="Delete"><i class="fas fa-trash"></i></a></td>
                    </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="/menu-simpan/" method="post">
