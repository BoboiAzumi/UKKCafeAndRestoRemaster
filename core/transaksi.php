        ...
        <div class="row">
            ...
            <div class="col-8 detaild" style="margin-left: -29px;">
                <div class="jumbotron card border-info mb-3">
                    <div class="flx title" style="justify-content:center"></div>
                ...
                if(confirm('Data akan disimpan?')){
                    ...
                    $.ajax({
                        ...
                        success:function(result){
                            ...
                            $('.tampilkanTransaksiDetail').load("/transaksi-detail/", {noTransaksi:noTransaksi});
                        }
                    });
                }
                else
