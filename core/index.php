...
<html lang="en">
    ...
    <body>
        <div class="kotak">
            <form class="form-signin" action="proses" method="post">
                ...
                <div class="inputgr">
                    <div class="input-group mb-o px-3">
                        <div class="input-group-text" style="background-color:rgba(229, 229, 229, 0.8)">
                            <i class="fas fa-user text-dark mis">
                            </i>
                        </div>
                        <input type="text" id="username" name="username" class="form-control form-control-sm" style="background-color:rgba(229, 229, 229, 0.8)" placeholder="Username" autocomplete="off" autofocus="on" required/>
                    </div>
                    <div class="input-group mb-1 px-3">
                        <div class="input-group-text" style="background-color:rgba(229, 229, 229, 0.8)">
                            <i class="fas fa-key text-dark">
                            </i>
                        </div>
                        <input type="password" id="password" name="password" class="form-control form-control-sm" style="background-color:rgba(229, 229, 229, 0.8)" placeholder="Password" autocomplete="off" required/>
                    </div>
                    <div class="fl">
