<div class="jumbotron col-9">
    <div class="container">
        <div class="row">
            <div class="col">
                <h2>Rekapitulasi Transaksi Tahun Ini</h2>
                <div class="input-group mb-1">
                    <span class="input-group-text lebar1">Dari</span>
                    <input type="date" id="periodeDari" class="form-control form-control-sm" value="<?=$tahunIni;?>" disabled>
                ...
                <div id="tampilkanTransaksiPeriode">
                    <table class="table table-bordered table-responsive table-hover table-sm" id="tblTransaksi">
                        ...
                        <tbody>
                            ...
                            $no = 1;
                            // $sql = "CALL pPetugas()";
                            $sql = "SELECT * FROM tbl_transaksi WHERE tgl_transaksi >= '$tahunIni' AND tgl_transaksi <= '$tglHariIni' ORDER BY tgl_transaksi ASC, no_transaksi";
