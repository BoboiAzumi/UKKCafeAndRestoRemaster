        ...
        <div class="row mt-5">
                ...
                <div class="accordion shadow" id="accordionExample">
                    <div class="card bgMenu hoverMenu">
                        <div class="card-header">
                            <h2 class="mb-0">
                                <a href="/dashboard/" class="btn btn-link btn-block text-left text-white"><strong class="border-secondary">DASHBOARD HOME</strong></a>
                            </h2>
                        </div>
                    </div>
                    ...
                    if($jabatan=="Admin"){
                    ?>
                        <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/login/">Master Login</a></div>
                        <?php
                    }else{
                    ?>
                    <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/pegawai/">Master Pegawai</a></div>
                    <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/menu/">Master Menu</a></div>
                    <?php
                }?>
                        </div>
                    </div>
            ...
            <div class="card">
                ...
                <div id="collapseTwo" class="collapse" data-parrent="#accordionExample">
                    <div class="card-body ml-4">
                        <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/transaksi/">Entri Transaksi</a></div>
                    </div>
                </div>
            </div>
            <!-- End Transaksi -->
            ...
            <div class="card">
                ...
                <div id="collapseThree" data-parent="#accordionExample">
                    ...
                    <?php
                        if($jabatan != "Admin"){?>
                            <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/transaksi-laporan/">Laporan Transaksi</a></div>
                        ...
                        if($jabatan=="Admin" or $jabatan == "Manajer"){?>
                            ...
                            <div class="menuMaster"><i class="fas fa-check-circle text-success"></i><a href="/log/">Log History..</a></div>
                        <?php
                    }?>
                            ...
                            <div class="card bgMenu hoverMenu">
                                <div class="card-header">
                                    <h2 class="mb-0">
                                        <a href="/logout/" class="btn btn-link btn-block text-left text-white"><strong class="border-secondary">LOG OUT</strong></a>
                                    </h2>
                                </div>
                            </div>
                        </div>
