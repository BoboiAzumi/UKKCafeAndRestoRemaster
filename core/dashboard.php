			...
			<div class="row mb-3">
				<div class="card col-6" style="background: rgba(57, 192, 237, 0.5);">
			  		<div class="card my-2 bg-light">
						...
						<div class="flx" style="justify-content:center">
							<button class="btn btn-info mb-3" id="lihat_detail_bulanan" onclick="location.href='/transaksi-laporan/?detail=bulan_ini'">Lihat Detail</button>
		  				</div>
					</div>
			  	  </div>
			  	 </div>
			  	  	  ...
			  	  	  <div class="card-body p-0 mr-1">
							...
							<div class="flx" style="justify-content:center" onclick="alert('Rp. <?=is_null($jml)?0 : $jml?>');">
								<button class="btn btn-info mb-3">?</button>
			  	  	  	  	...
			  	  	  	  	<p class="card-text text-center"><small class="text-muted">Jumlah dalam jutaan</small></p>
							<div class="flx" style="justify-content:center">
									<button class="btn btn-info mb-3" id="lihat_detail_harian" onclick="location.href='/transaksi-laporan/?detail=hari_ini'">Lihat Detail</button>
		  					</div>
			  	  	  	</div>
			  	  	  </div>
			  	  	</div>
			  	  	  ...
			  	  	  <div class="card-body p-0 mr-1">
							...
							<div class="flx" style="justify-content:center" onclick="alert('Rp. <?=is_null($jml)?0 : $jml?>');">
								<button class="btn btn-info mb-3">?</button>
			  	  	  	  	...
			  	  	  	  	<p class="card-text text-center"><small class="text-muted">Jumlah dalam jutaan</small></p>
							<div class="flx" style="justify-content:center">
									<button class="btn btn-info mb-3" id="lihat_detail_tahunan" onclick="location.href='/transaksi-laporan/?detail=tahun_ini'">Lihat Detail</button>
		  					</div>
			  	  	  	</div>
			  	  	  </div>
			  	  	</div>
			  	  ...
			  	  <div class="row">
			  	  	...
			  	  	<div class="col-md-7">
			  	  	  <div class="card-body p-0 mr-1">
							...
							<div class="flx" style="justify-content:center">
									<button class="btn btn-info mb-3" id="lihat_detail_keseluruhan" onclick="location.href='/transaksi-laporan/?detail=keseluruhan'">Lihat Detail</button>
		  					</div>
			  	  	  	</div>
			  	  	  </div>
			  	  	</div>
