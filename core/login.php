            ...
            <table class="table table-bordered table-hover table-responsive" id="login">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?= $data["username"];?></td>
                        <td><?= $data["jabatan"];?></td>
                        <td align="center" width="15%"><a href="/login-edit/?id_login=<?=$data['id_login'];?>" class="badge badge-primary p-2" title="Edit"><i class="fas fa-edit"></i></a> | <a href="/login-delete/?id_login=<?=$data['id_login'];?>" onclick="return confirm('Data akan dihapus ?');" class="badge badge-danger p-2" title="Delete"><i class="fas fa-trash"></i></a></td>
                    </tr>
