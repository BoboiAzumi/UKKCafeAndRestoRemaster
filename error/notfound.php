...
<html>
    ...
    <body>
        <div class="kotak">
            ...
            <img src="/img/notfound.png" alt="Logonya Error Bang" width="200px" height="200px" style="margin-left:14px;">
            <div style="margin-left:0px;margin-top:35px;font-size:22px;margin-bottom:15px;">404 Not Found<br>(File Tidak Ditemukan)</div>
